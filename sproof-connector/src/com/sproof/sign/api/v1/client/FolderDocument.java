...
public class FolderDocument {
  ...
  public FolderDocument name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public FolderDocument state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public FolderDocument documentId(String documentId) {
  ...
  **/
  ...
  public FolderDocument memberId(String memberId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FolderDocument _folderDocument = (FolderDocument) o;
    return Objects.equals(this.name, _folderDocument.name) &&
        Objects.equals(this.state, _folderDocument.state) &&
        Objects.equals(this.documentId, _folderDocument.documentId) &&
        Objects.equals(this.memberId, _folderDocument.memberId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, state, documentId, memberId);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderDocument {\n");
