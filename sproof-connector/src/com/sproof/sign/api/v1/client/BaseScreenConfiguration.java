...
public class BaseScreenConfiguration {
  ...
  public BaseScreenConfiguration enabled(Boolean enabled) {
    this.enabled = enabled;
    return this;
  }

   /**
   * Determines whether the screen is enabled.
   * @return enabled
  **/
  ...
  public BaseScreenConfiguration title(String title) {
    this.title = title;
    return this;
  }
  ...
  **/
  ...
  public BaseScreenConfiguration description(String description) {
  ...
  **/
  ...
  public BaseScreenConfiguration icon(Boolean icon) {
    this.icon = icon;
    return this;
  }

   /**
   * Displays an icon on the screen if enabled.
   * @return icon
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BaseScreenConfiguration _baseScreenConfiguration = (BaseScreenConfiguration) o;
    return Objects.equals(this.enabled, _baseScreenConfiguration.enabled) &&
        Objects.equals(this.title, _baseScreenConfiguration.title) &&
        Objects.equals(this.description, _baseScreenConfiguration.description) &&
        Objects.equals(this.icon, _baseScreenConfiguration.icon);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, title, description, icon);
  }
  ...
  public String toString() {
    ...
    sb.append("class BaseScreenConfiguration {\n");
