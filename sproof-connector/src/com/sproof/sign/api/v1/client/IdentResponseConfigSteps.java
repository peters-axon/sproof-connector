...
import com.sproof.sign.api.v1.client.IdentResponseConfigStepsWelcome;

/**
 * IdentResponseConfigSteps
 */
...
public class IdentResponseConfigSteps {
  @JsonProperty("welcome")
  private IdentResponseConfigStepsWelcome welcome = null;

  @JsonProperty("end")
  private IdentResponseConfigStepsWelcome end = null;

  public IdentResponseConfigSteps welcome(IdentResponseConfigStepsWelcome welcome) {
   ...
   * @return welcome
  **/
  public IdentResponseConfigStepsWelcome getWelcome() {
    return welcome;
  }

  public void setWelcome(IdentResponseConfigStepsWelcome welcome) {
    this.welcome = welcome;
  }

  public IdentResponseConfigSteps end(IdentResponseConfigStepsWelcome end) {
    this.end = end;
    return this;
  }
   ...
   * @return end
  **/
  public IdentResponseConfigStepsWelcome getEnd() {
    return end;
  }

  public void setEnd(IdentResponseConfigStepsWelcome end) {
    this.end = end;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IdentResponseConfigSteps identResponseConfigSteps = (IdentResponseConfigSteps) o;
    return Objects.equals(this.welcome, identResponseConfigSteps.welcome) &&
        Objects.equals(this.end, identResponseConfigSteps.end);
  }
  ...
  public String toString() {
    ...
    sb.append("class IdentResponseConfigSteps {\n");
