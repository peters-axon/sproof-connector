...
import com.sproof.sign.api.v1.client.MemberIdentification;
...
public class PlanMember {
  ...
  private MemberIdentification identification = null;
  ...
  @JsonProperty("userPlus")
  private Boolean userPlus = null;

  @JsonProperty("lastLoginAt")
  private OffsetDateTime lastLoginAt = null;

  public PlanMember email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public PlanMember firstName(String firstName) {
  ...
  **/
  ...
  public PlanMember lastName(String lastName) {
  ...
  **/
  ...
  public PlanMember identification(MemberIdentification identification) {
  ...
  **/
  public MemberIdentification getIdentification() {
    return identification;
  }

  public void setIdentification(MemberIdentification identification) {
    this.identification = identification;
  }

  public PlanMember blockedAt(OffsetDateTime blockedAt) {
    this.blockedAt = blockedAt;
    return this;
  }

   /**
   * Date when the member was blocked
   * @return blockedAt
  **/
  ...
  public PlanMember isPending(Boolean isPending) {
    this.isPending = isPending;
    return this;
  }

   /**
   * If you create a new member without choosing to \&quot;register\&quot; the user, the member will be pending. This means that the user first have to create an account and login then accept the invitation to join the plan. If the user does not accept the invitation, the member will remain pending.
   * @return isPending
  **/
  ...
  public PlanMember userPlus(Boolean userPlus) {
    this.userPlus = userPlus;
    return this;
  }

   /**
   * This is a boolean that indicates if the member is a qualified user. This means this member will have a userPlus license and is not currently blocked.
   * @return userPlus
  **/
  ...
  public PlanMember lastLoginAt(OffsetDateTime lastLoginAt) {
    this.lastLoginAt = lastLoginAt;
    return this;
  }

   /**
   * Last login date of the member
   * @return lastLoginAt
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.email, planMember.email) &&
        Objects.equals(this.firstName, planMember.firstName) &&
        Objects.equals(this.lastName, planMember.lastName) &&
        Objects.equals(this.identification, planMember.identification) &&
        Objects.equals(this.blockedAt, planMember.blockedAt) &&
        Objects.equals(this.isPending, planMember.isPending) &&
        Objects.equals(this.userPlus, planMember.userPlus) &&
        Objects.equals(this.lastLoginAt, planMember.lastLoginAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, identification, blockedAt, isPending, userPlus, lastLoginAt);
  }
  ...
  public String toString() {
    ...
    sb.append("    userPlus: ").append(toIndentedString(userPlus)).append("\n");
