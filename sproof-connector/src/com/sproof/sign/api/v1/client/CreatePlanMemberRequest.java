...
public class CreatePlanMemberRequest {
  @JsonProperty("token")
  ...
  private Boolean userPlus = false;

  @JsonProperty("sendEmail")
  private Boolean sendEmail = true;

  public CreatePlanMemberRequest token(String token) {
    this.token = token;
    return this;
  }

   /**
   * Your api token, you can find it in the settings page of the administrator profile
   * @return token
  **/
  ...
  public CreatePlanMemberRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public CreatePlanMemberRequest firstName(String firstName) {
  ...
  **/
  ...
  public CreatePlanMemberRequest lastName(String lastName) {
  ...
  **/
  ...
  public CreatePlanMemberRequest register(Boolean register) {
    this.register = register;
    return this;
  }

   /**
   * If true, also create a user if one does not exist. An email will be sent out with a link to create a password for the account. Once the account is created, the user will be already added to the plan and will be able to login
   * @return register
  **/
  ...
  public CreatePlanMemberRequest userPlus(Boolean userPlus) {
    this.userPlus = userPlus;
    return this;
  }

   /**
   * If true, this user will have userPlus license, this will enable your user to identify with a qualified signature provider and sign documents with a qualified signature if required
   * @return userPlus
  **/
  ...
  public CreatePlanMemberRequest sendEmail(Boolean sendEmail) {
    this.sendEmail = sendEmail;
    return this;
  }

   /**
   * If true, send invite email. Use false for SSO use cases.
   * @return sendEmail
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreatePlanMemberRequest createPlanMemberRequest = (CreatePlanMemberRequest) o;
    return Objects.equals(this.token, createPlanMemberRequest.token) &&
        Objects.equals(this.email, createPlanMemberRequest.email) &&
        Objects.equals(this.firstName, createPlanMemberRequest.firstName) &&
        Objects.equals(this.lastName, createPlanMemberRequest.lastName) &&
        Objects.equals(this.register, createPlanMemberRequest.register) &&
        Objects.equals(this.userPlus, createPlanMemberRequest.userPlus) &&
        Objects.equals(this.sendEmail, createPlanMemberRequest.sendEmail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, email, firstName, lastName, register, userPlus, sendEmail);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreatePlanMemberRequest {\n");
