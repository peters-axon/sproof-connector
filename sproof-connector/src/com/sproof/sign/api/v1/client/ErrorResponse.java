...
public class ErrorResponse {
  ...
  **/
  ...
  public ErrorResponse traceId(String traceId) {
   ...
   /**
   * Trace ID - Provide this to the sproof support team to help them debug the issue
   * @return traceId
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ErrorResponse _errorResponse = (ErrorResponse) o;
    return Objects.equals(this.message, _errorResponse.message) &&
        Objects.equals(this.traceId, _errorResponse.traceId);
  }
