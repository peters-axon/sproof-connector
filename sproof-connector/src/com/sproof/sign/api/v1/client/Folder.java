...
import com.sproof.sign.api.v1.client.FolderDocument;
import com.sproof.sign.api.v1.client.FolderMember;
...
public class Folder {
  ...
  private List<FolderMember> members = null;

  @JsonProperty("documents")
  private List<FolderDocument> documents = null;
  ...
  **/
  ...
  public Folder createdAt(LocalDate createdAt) {
  ...
  **/
  ...
  public Folder state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public Folder isAdmin(Boolean isAdmin) {
  ...
  **/
  ...
  public Folder members(List<FolderMember> members) {
    this.members = members;
    return this;
  }

  public Folder addMembersItem(FolderMember membersItem) {
   ...
   * @return members
  **/
  public List<FolderMember> getMembers() {
    return members;
  }

  public void setMembers(List<FolderMember> members) {
    this.members = members;
  }

  public Folder documents(List<FolderDocument> documents) {
    this.documents = documents;
    return this;
  }

  public Folder addDocumentsItem(FolderDocument documentsItem) {
  ...
  **/
  ...
  public void setDocuments(List<FolderDocument> documents) {
    this.documents = documents;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Folder _folder = (Folder) o;
    return Objects.equals(this.name, _folder.name) &&
        Objects.equals(this.createdAt, _folder.createdAt) &&
        Objects.equals(this.state, _folder.state) &&
        Objects.equals(this.isAdmin, _folder.isAdmin) &&
        Objects.equals(this.members, _folder.members) &&
        Objects.equals(this.documents, _folder.documents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, createdAt, state, isAdmin, members, documents);
  }
