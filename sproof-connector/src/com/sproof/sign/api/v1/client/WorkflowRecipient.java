...
public class WorkflowRecipient {
  ...
  public WorkflowRecipient email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public WorkflowRecipient firstName(String firstName) {
  ...
  **/
  ...
  public WorkflowRecipient lastName(String lastName) {
  ...
  **/
  ...
  public WorkflowRecipient phoneNumber(String phoneNumber) {
    this.phoneNumber = phoneNumber;
    return this;
  }

   /**
   * Phone number of the recipient. Used for SMS notifications if enabled.
   * @return phoneNumber
  **/
  ...
  public WorkflowRecipient placeholderText(String placeholderText) {
    this.placeholderText = placeholderText;
    return this;
  }

   /**
   * Text placeholder identifier used to match this recipient to a signature position specified on the document.
  ...
  **/
  ...
  public WorkflowRecipient index(Integer index) {
    this.index = index;
    return this;
  }

   /**
   * Index of the recipient placeholder in the workflow. The index starts at 1 and corresponds to the order of placeholders defined in the workflow.
   * minimum: 1
   * @return index
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WorkflowRecipient workflowRecipient = (WorkflowRecipient) o;
    return Objects.equals(this.email, workflowRecipient.email) &&
        Objects.equals(this.firstName, workflowRecipient.firstName) &&
        Objects.equals(this.lastName, workflowRecipient.lastName) &&
        Objects.equals(this.phoneNumber, workflowRecipient.phoneNumber) &&
        Objects.equals(this.placeholderText, workflowRecipient.placeholderText) &&
        Objects.equals(this.index, workflowRecipient.index);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, phoneNumber, placeholderText, index);
  }
  ...
  public String toString() {
    ...
    sb.append("class WorkflowRecipient {\n");
