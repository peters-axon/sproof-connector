...
public class DocumentRequestBody {
  ...
  @JsonProperty("y")
  private BigDecimal y = new BigDecimal(0.9);

  @JsonProperty("width")
  private BigDecimal width = new BigDecimal(0.3);

  @JsonProperty("height")
  private BigDecimal height = new BigDecimal(0.1);
  ...
  public DocumentRequestBody token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public DocumentRequestBody data(String data) {
    this.data = data;
    return this;
  }

   /**
   * Base64 Encoded Pdf File as string, represented by the BASE64PDF token
   * @return data
  **/
  ...
  public DocumentRequestBody signature(String signature) {
    this.signature = signature;
    return this;
  }

   /**
   * Base64 Encoded PNG File as a string which represents the signature or seal, represented by the BASE64PNGorJPG token
   * @return signature
  **/
  ...
  public DocumentRequestBody page(BigDecimal page) {
    this.page = page;
    return this;
  }

   /**
   * Page number, starting at 0 ,if you pass a page number that is not out of bounds, the last page of the document will be used
   * @return page
  **/
  ...
  public DocumentRequestBody x(BigDecimal x) {
    this.x = x;
    return this;
  }

   /**
   * x coordinate of the signature image, default is bottom right position, where 0 is the leftmost edge and 1 is the rightmost edge of the page
   * minimum: 0
   * maximum: 1
   * @return x
  **/
  ...
  public DocumentRequestBody y(BigDecimal y) {
    this.y = y;
    return this;
  }

   /**
   * y coordinate of the signature image, default values are for bottom right, where 0 is the bottom edge and 1 is the top edge of the page
   * minimum: 0
   * maximum: 1
   * @return y
  **/
  ...
  public DocumentRequestBody width(BigDecimal width) {
    this.width = width;
    return this;
  }

   /**
   * Width of the signature, relative to the page width, where 1 represents the full width of the page
   * minimum: 0
   * maximum: 1
   * @return width
  **/
  ...
  public DocumentRequestBody height(BigDecimal height) {
    this.height = height;
    return this;
  }

   /**
   * Height of the signature, relative to the page height, where 1 represents the full height of the page
   * minimum: 0
   * maximum: 1
   * @return height
  **/
  ...
  public DocumentRequestBody name(String name) {
    this.name = name;
    return this;
  }

   /**
   * Name of the signer, defaults to API token holder name
   * @return name
  **/
  ...
  public DocumentRequestBody email(String email) {
    this.email = email;
    return this;
  }

   /**
   * Email of the signer, defaults to API token holder email
   * @return email
  **/
  ...
  public DocumentRequestBody key(String key) {
    this.key = key;
    return this;
  }
  ...
  **/
  ...
  public DocumentRequestBody password(String password) {
  ...
  **/
  ...
  public DocumentRequestBody signatureCard(Boolean signatureCard) {
    this.signatureCard = signatureCard;
    return this;
  }

   /**
   * Flag to add a signature card with a visual timestamp that can include a custom image or name based on above parameters, defaults to true if no signature image is provided and uses the api token holder name and email as default values
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DocumentRequestBody _documentRequestBody = (DocumentRequestBody) o;
    return Objects.equals(this.token, _documentRequestBody.token) &&
        Objects.equals(this.data, _documentRequestBody.data) &&
        Objects.equals(this.signature, _documentRequestBody.signature) &&
        Objects.equals(this.page, _documentRequestBody.page) &&
        Objects.equals(this.x, _documentRequestBody.x) &&
        Objects.equals(this.y, _documentRequestBody.y) &&
        Objects.equals(this.width, _documentRequestBody.width) &&
        Objects.equals(this.height, _documentRequestBody.height) &&
        Objects.equals(this.name, _documentRequestBody.name) &&
        Objects.equals(this.email, _documentRequestBody.email) &&
        Objects.equals(this.key, _documentRequestBody.key) &&
        Objects.equals(this.password, _documentRequestBody.password) &&
        Objects.equals(this.signatureCard, _documentRequestBody.signatureCard);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, data, signature, page, x, y, width, height, name, email, key, password, signatureCard);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentRequestBody {\n");
    ...
    sb.append("    signatureCard: ").append(toIndentedString(signatureCard)).append("\n");
    sb.append("}");
    return sb.toString();
  }
