...
public class DeleteFastlaneProfileResponse {
  @JsonProperty("deletedProfiles")
  private List<UUID> deletedProfiles = null;

  public DeleteFastlaneProfileResponse deletedProfiles(List<UUID> deletedProfiles) {
    this.deletedProfiles = deletedProfiles;
    return this;
  }

  public DeleteFastlaneProfileResponse addDeletedProfilesItem(UUID deletedProfilesItem) {
    if (this.deletedProfiles == null) {
      this.deletedProfiles = new ArrayList<>();
    }
    this.deletedProfiles.add(deletedProfilesItem);
    return this;
  }

   /**
   * A list of profile IDs that have been successfully deleted.
   * @return deletedProfiles
  **/
  public List<UUID> getDeletedProfiles() {
    return deletedProfiles;
  }

  public void setDeletedProfiles(List<UUID> deletedProfiles) {
    this.deletedProfiles = deletedProfiles;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeleteFastlaneProfileResponse deleteFastlaneProfileResponse = (DeleteFastlaneProfileResponse) o;
    return Objects.equals(this.deletedProfiles, deleteFastlaneProfileResponse.deletedProfiles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deletedProfiles);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteFastlaneProfileResponse {\n");
    
    sb.append("    deletedProfiles: ").append(toIndentedString(deletedProfiles)).append("\n");
    sb.append("}");
    return sb.toString();
  }
