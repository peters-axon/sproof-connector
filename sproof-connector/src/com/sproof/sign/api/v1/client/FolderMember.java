...
public class FolderMember {
  ...
  private OneOfFolderMemberSignaturePosition signaturePosition = null;

  @JsonProperty("signingOrder")
  private BigDecimal signingOrder = null;

  @JsonProperty("declinedAt")
  private LocalDate declinedAt = null;

  public FolderMember id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public FolderMember documentId(String documentId) {
    this.documentId = documentId;
    return this;
  }

   /**
   * Document ID of the document the member is on
   * @return documentId
  **/
  ...
  public FolderMember email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public FolderMember firstName(String firstName) {
  ...
  **/
  ...
  public FolderMember lastName(String lastName) {
  ...
  **/
  ...
  public FolderMember lastActivityAt(LocalDate lastActivityAt) {
  ...
  **/
  ...
  public FolderMember createdAt(LocalDate createdAt) {
    this.createdAt = createdAt;
    return this;
  }

   /**
   * Date and time of document upload
   * @return createdAt
  **/
  ...
  public FolderMember isAdmin(Boolean isAdmin) {
  ...
  **/
  ...
  public FolderMember signaturePosition(OneOfFolderMemberSignaturePosition signaturePosition) {
    this.signaturePosition = signaturePosition;
    return this;
  }

   /**
   * Based on what is sent in the request you can expect.
   * @return signaturePosition
  **/
  public OneOfFolderMemberSignaturePosition getSignaturePosition() {
    return signaturePosition;
  }

  public void setSignaturePosition(OneOfFolderMemberSignaturePosition signaturePosition) {
    this.signaturePosition = signaturePosition;
  }

  public FolderMember signingOrder(BigDecimal signingOrder) {
  ...
  **/
  ...
  public FolderMember declinedAt(LocalDate declinedAt) {
   ...
   * @return declinedAt
  **/
  public LocalDate getDeclinedAt() {
    return declinedAt;
  }

  public void setDeclinedAt(LocalDate declinedAt) {
    this.declinedAt = declinedAt;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FolderMember _folderMember = (FolderMember) o;
    return Objects.equals(this.id, _folderMember.id) &&
        Objects.equals(this.documentId, _folderMember.documentId) &&
        Objects.equals(this.email, _folderMember.email) &&
        Objects.equals(this.firstName, _folderMember.firstName) &&
        Objects.equals(this.lastName, _folderMember.lastName) &&
        Objects.equals(this.lastActivityAt, _folderMember.lastActivityAt) &&
        Objects.equals(this.createdAt, _folderMember.createdAt) &&
        Objects.equals(this.isAdmin, _folderMember.isAdmin) &&
        Objects.equals(this.signaturePosition, _folderMember.signaturePosition) &&
        Objects.equals(this.signingOrder, _folderMember.signingOrder) &&
        Objects.equals(this.declinedAt, _folderMember.declinedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, documentId, email, firstName, lastName, lastActivityAt, createdAt, isAdmin, signaturePosition, signingOrder, declinedAt);
  }
