...
/**
 * Information about a recipient of the signature request
 */
...
public class CSRRecipient {
  ...
  public CSRRecipient email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public CSRRecipient firstName(String firstName) {
  ...
  **/
  ...
  public CSRRecipient lastName(String lastName) {
  ...
  **/
  ...
  public CSRRecipient doNotSendEmails(Boolean doNotSendEmails) {
  ...
  **/
  ...
  public CSRRecipient useFastlane(Boolean useFastlane) {
    this.useFastlane = useFastlane;
    return this;
  }

   /**
   * If set to true the recipient receives a Fastlane link
   * @return useFastlane
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CSRRecipient csRRecipient = (CSRRecipient) o;
    return Objects.equals(this.email, csRRecipient.email) &&
        Objects.equals(this.firstName, csRRecipient.firstName) &&
        Objects.equals(this.lastName, csRRecipient.lastName) &&
        Objects.equals(this.doNotSendEmails, csRRecipient.doNotSendEmails) &&
        Objects.equals(this.useFastlane, csRRecipient.useFastlane);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, doNotSendEmails, useFastlane);
  }
