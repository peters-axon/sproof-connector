...
/**
 * Qualified member request object
 */
...
public class QualifiedMemberRequestObject {
  @JsonProperty("token")
  ...
  public QualifiedMemberRequestObject token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public QualifiedMemberRequestObject email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public QualifiedMemberRequestObject register(Boolean register) {
    this.register = register;
    return this;
  }

   /**
   * Boolean which indicates that sproof will automatically create an account for the qualified member, If set to &#x60;true&#x60; then &#x60;firstName&#x60; and &#x60;lastName&#x60; become required also .
   * @return register
  **/
  ...
  public QualifiedMemberRequestObject firstName(String firstName) {
    this.firstName = firstName;
    return this;
  }

   /**
   * First name of qualified member, becomes &#x60;required&#x60; parameter if &#x60;register&#x60; is set to &#x60;true&#x60;
   * @return firstName
  **/
  ...
  public QualifiedMemberRequestObject lastName(String lastName) {
    this.lastName = lastName;
    return this;
  }

   /**
   * Last name of qualified member, becomes &#x60;required&#x60; parameter if &#x60;register&#x60; is set to &#x60;true&#x60;
   * @return lastName
  **/
  ...
  public QualifiedMemberRequestObject phoneNumber(String phoneNumber) {
  ...
  **/
  ...
  public QualifiedMemberRequestObject doNotSendEmail(Boolean doNotSendEmail) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QualifiedMemberRequestObject _qualifiedMemberRequestObject = (QualifiedMemberRequestObject) o;
    return Objects.equals(this.token, _qualifiedMemberRequestObject.token) &&
        Objects.equals(this.email, _qualifiedMemberRequestObject.email) &&
        Objects.equals(this.register, _qualifiedMemberRequestObject.register) &&
        Objects.equals(this.firstName, _qualifiedMemberRequestObject.firstName) &&
        Objects.equals(this.lastName, _qualifiedMemberRequestObject.lastName) &&
        Objects.equals(this.phoneNumber, _qualifiedMemberRequestObject.phoneNumber) &&
        Objects.equals(this.doNotSendEmail, _qualifiedMemberRequestObject.doNotSendEmail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, email, register, firstName, lastName, phoneNumber, doNotSendEmail);
  }
  ...
  public String toString() {
    ...
    sb.append("class QualifiedMemberRequestObject {\n");
