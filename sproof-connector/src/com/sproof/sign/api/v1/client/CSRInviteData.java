...
import com.sproof.sign.api.v1.client.CSRRecipient;
import com.sproof.sign.api.v1.client.CSRSender;
...
public class CSRInviteData {
  @JsonProperty("sender")
  private CSRSender sender = null;

  @JsonProperty("recipients")
  private List<CSRRecipient> recipients = new ArrayList<>();
  ...
  public CSRInviteData sender(CSRSender sender) {
    this.sender = sender;
    return this;
  }
   ...
   * @return sender
  **/
  public CSRSender getSender() {
    return sender;
  }

  public void setSender(CSRSender sender) {
    this.sender = sender;
  }

  public CSRInviteData recipients(List<CSRRecipient> recipients) {
    this.recipients = recipients;
    return this;
  }

  public CSRInviteData addRecipientsItem(CSRRecipient recipientsItem) {
   ...
   * @return recipients
  **/
  public List<CSRRecipient> getRecipients() {
    return recipients;
  }

  public void setRecipients(List<CSRRecipient> recipients) {
    this.recipients = recipients;
  }

  public CSRInviteData signatureTypes(List<String> signatureTypes) {
    this.signatureTypes = signatureTypes;
    return this;
  }

  public CSRInviteData addSignatureTypesItem(String signatureTypesItem) {
   ...
   /**
   * The types of signatures that are allowed. Options: [&#x27;advanced&#x27;, &#x27;advancedPlus&#x27;, &#x27;qualified&#x27;, &#x27;simple&#x27;, &#x27;qualifiedPlusIdent&#x27;]
  ...
  **/
  ...
  public CSRInviteData subject(String subject) {
  ...
  **/
  ...
  public CSRInviteData message(String message) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CSRInviteData csRInviteData = (CSRInviteData) o;
    return Objects.equals(this.sender, csRInviteData.sender) &&
        Objects.equals(this.recipients, csRInviteData.recipients) &&
        Objects.equals(this.signatureTypes, csRInviteData.signatureTypes) &&
        Objects.equals(this.subject, csRInviteData.subject) &&
        Objects.equals(this.message, csRInviteData.message);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sender, recipients, signatureTypes, subject, message);
  }
