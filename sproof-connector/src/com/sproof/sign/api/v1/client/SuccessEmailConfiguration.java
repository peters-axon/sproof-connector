...
/**
 * Customization settings for the success email sent after completion.
 */
...
public class SuccessEmailConfiguration {
  @JsonProperty("subject")
  private String subject = "[recipient_name] has signed [document_name]";

  @JsonProperty("title")
  private String title = "You have signed [document_name]";

  @JsonProperty("text")
  private String text = "[document_name] was signed successfully. You can find the document in the attachment or view it in the dashboard.";

  @JsonProperty("sendEmail")
  private Boolean sendEmail = true;

  public SuccessEmailConfiguration subject(String subject) {
    this.subject = subject;
    return this;
  }

   /**
   * Subject line of the success email.
   * @return subject
  **/
  ...
  public SuccessEmailConfiguration title(String title) {
    this.title = title;
    return this;
  }

   /**
   * Title of the success email.
   * @return title
  **/
  ...
  public SuccessEmailConfiguration text(String text) {
    this.text = text;
    return this;
  }

   /**
   * Body text of the success email.
   * @return text
  **/
  ...
  public SuccessEmailConfiguration sendEmail(Boolean sendEmail) {
    this.sendEmail = sendEmail;
    return this;
  }

   /**
   * If set to false, an email will not be sent to the signer.
   * @return sendEmail
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SuccessEmailConfiguration _successEmailConfiguration = (SuccessEmailConfiguration) o;
    return Objects.equals(this.subject, _successEmailConfiguration.subject) &&
        Objects.equals(this.title, _successEmailConfiguration.title) &&
        Objects.equals(this.text, _successEmailConfiguration.text) &&
        Objects.equals(this.sendEmail, _successEmailConfiguration.sendEmail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subject, title, text, sendEmail);
  }
  ...
  public String toString() {
    ...
    sb.append("class SuccessEmailConfiguration {\n");
