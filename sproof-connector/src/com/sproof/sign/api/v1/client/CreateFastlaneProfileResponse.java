...
import com.sproof.sign.api.v1.client.FastlaneConfiguration;
...
public class CreateFastlaneProfileResponse {
  @JsonProperty("id")
  ...
  private FastlaneConfiguration _configuration = null;

  public CreateFastlaneProfileResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public CreateFastlaneProfileResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public CreateFastlaneProfileResponse createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public CreateFastlaneProfileResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public CreateFastlaneProfileResponse _configuration(FastlaneConfiguration _configuration) {
  ...
  **/
  public FastlaneConfiguration getConfiguration() {
    return _configuration;
  }

  public void setConfiguration(FastlaneConfiguration _configuration) {
    this._configuration = _configuration;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateFastlaneProfileResponse createFastlaneProfileResponse = (CreateFastlaneProfileResponse) o;
    return Objects.equals(this.id, createFastlaneProfileResponse.id) &&
        Objects.equals(this.name, createFastlaneProfileResponse.name) &&
        Objects.equals(this.createdAt, createFastlaneProfileResponse.createdAt) &&
        Objects.equals(this.updatedAt, createFastlaneProfileResponse.updatedAt) &&
        Objects.equals(this._configuration, createFastlaneProfileResponse._configuration);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, createdAt, updatedAt, _configuration);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateFastlaneProfileResponse {\n");
