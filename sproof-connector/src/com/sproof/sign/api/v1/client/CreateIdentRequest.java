...
import com.sproof.sign.api.v1.client.AdditionalChecks;
import com.sproof.sign.api.v1.client.Attributes;
import com.sproof.sign.api.v1.client.CreateIdentRequestConfig;
import com.sproof.sign.api.v1.client.IdentTypes;
import com.sproof.sign.api.v1.client.LanguageEnum;
import com.sproof.sign.api.v1.client.Metadata;
...
public class CreateIdentRequest {
  ...
  @JsonProperty("config")
  private CreateIdentRequestConfig config = null;

  @JsonProperty("identTypes")
  private IdentTypes identTypes = null;
  ...
  private AdditionalChecks additionalChecks = null;

  @JsonProperty("language")
  private LanguageEnum language = null;

  public CreateIdentRequest attributes(Attributes attributes) {
  ...
  **/
  ...
  public CreateIdentRequest config(CreateIdentRequestConfig config) {
    this.config = config;
    return this;
  }
   ...
   * @return config
  **/
  public CreateIdentRequestConfig getConfig() {
    return config;
  }

  public void setConfig(CreateIdentRequestConfig config) {
    this.config = config;
  }

  public CreateIdentRequest identTypes(IdentTypes identTypes) {
   ...
   * @return identTypes
  **/
  public IdentTypes getIdentTypes() {
    return identTypes;
  }

  public void setIdentTypes(IdentTypes identTypes) {
    this.identTypes = identTypes;
  }

  public CreateIdentRequest callback(String callback) {
    this.callback = callback;
    return this;
  }

   /**
   * Webhook URL to notify Relying Party when identification completes
   * @return callback
  **/
  ...
  public CreateIdentRequest returnUrl(String returnUrl) {
    this.returnUrl = returnUrl;
    return this;
  }

   /**
   * URL to redirect End User after successful identification
   * @return returnUrl
  **/
  ...
  public CreateIdentRequest returnUrlLabel(String returnUrlLabel) {
    this.returnUrlLabel = returnUrlLabel;
    return this;
  }

   /**
   * Label text for the return URL button shown to End User
  ...
  **/
  ...
  public CreateIdentRequest brandingDomain(String brandingDomain) {
    this.brandingDomain = brandingDomain;
    return this;
  }

   /**
   * Custom branding domain for white-label UI
  ...
  **/
  ...
  public CreateIdentRequest selectedNationalProvider(NationalProviderEnum selectedNationalProvider) {
  ...
  **/
  ...
  public CreateIdentRequest canChangeNationalProvider(Boolean canChangeNationalProvider) {
    this.canChangeNationalProvider = canChangeNationalProvider;
    return this;
  }

   /**
   * Whether End User can change the pre-selected national provider
  ...
  **/
  ...
  public CreateIdentRequest metadata(Metadata metadata) {
  ...
  **/
  ...
  public CreateIdentRequest additionalChecks(AdditionalChecks additionalChecks) {
  ...
  **/
  ...
  public CreateIdentRequest language(LanguageEnum language) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateIdentRequest createIdentRequest = (CreateIdentRequest) o;
    return Objects.equals(this.attributes, createIdentRequest.attributes) &&
        Objects.equals(this.config, createIdentRequest.config) &&
        Objects.equals(this.identTypes, createIdentRequest.identTypes) &&
        Objects.equals(this.callback, createIdentRequest.callback) &&
        Objects.equals(this.returnUrl, createIdentRequest.returnUrl) &&
        Objects.equals(this.returnUrlLabel, createIdentRequest.returnUrlLabel) &&
        Objects.equals(this.brandingDomain, createIdentRequest.brandingDomain) &&
        Objects.equals(this.selectedNationalProvider, createIdentRequest.selectedNationalProvider) &&
        Objects.equals(this.canChangeNationalProvider, createIdentRequest.canChangeNationalProvider) &&
        Objects.equals(this.metadata, createIdentRequest.metadata) &&
        Objects.equals(this.additionalChecks, createIdentRequest.additionalChecks) &&
        Objects.equals(this.language, createIdentRequest.language);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributes, config, identTypes, callback, returnUrl, returnUrlLabel, brandingDomain, selectedNationalProvider, canChangeNationalProvider, metadata, additionalChecks, language);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIdentRequest {\n");
