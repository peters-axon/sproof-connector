...
/**
 * Request body for deleting documents from an envelope
 */
...
public class DeleteFolderDocumentsRequest {
  @JsonProperty("documentIds")
  private List<String> documentIds = new ArrayList<>();

  public DeleteFolderDocumentsRequest documentIds(List<String> documentIds) {
    this.documentIds = documentIds;
    return this;
  }

  public DeleteFolderDocumentsRequest addDocumentIdsItem(String documentIdsItem) {
    this.documentIds.add(documentIdsItem);
    return this;
  }

   /**
   * List of document IDs to be removed from the envelope
   * @return documentIds
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DeleteFolderDocumentsRequest _deleteFolderDocumentsRequest = (DeleteFolderDocumentsRequest) o;
    return Objects.equals(this.documentIds, _deleteFolderDocumentsRequest.documentIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteFolderDocumentsRequest {\n");
