...
public class AddProfileToDocumentRequest {
  @JsonProperty("memberIds")
  private List<String> memberIds = null;

  public AddProfileToDocumentRequest memberIds(List<String> memberIds) {
    this.memberIds = memberIds;
    return this;
  }

  public AddProfileToDocumentRequest addMemberIdsItem(String memberIdsItem) {
   ...
   /**
   * A list of unique admin memberIds. Each id corresponds to a document that will be configured to use the Fastlane profile specified.  **Note: The Fastlane profile is only visible to recipients where the useFastlane flag was set at the time of the invite.** 
   * @return memberIds
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AddProfileToDocumentRequest addProfileToDocumentRequest = (AddProfileToDocumentRequest) o;
    return Objects.equals(this.memberIds, addProfileToDocumentRequest.memberIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddProfileToDocumentRequest {\n");
