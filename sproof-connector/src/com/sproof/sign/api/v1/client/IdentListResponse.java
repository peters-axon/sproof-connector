...
import com.sproof.sign.api.v1.client.IdentListResponsePagination;
import com.sproof.sign.api.v1.client.IdentResponse;
...
public class IdentListResponse {
  @JsonProperty("data")
  private List<IdentResponse> data = new ArrayList<>();

  @JsonProperty("pagination")
  private IdentListResponsePagination pagination = null;

  public IdentListResponse data(List<IdentResponse> data) {
    this.data = data;
    return this;
  }

  public IdentListResponse addDataItem(IdentResponse dataItem) {
   ...
   * @return data
  **/
  public List<IdentResponse> getData() {
    return data;
  }

  public void setData(List<IdentResponse> data) {
    this.data = data;
  }

  public IdentListResponse pagination(IdentListResponsePagination pagination) {
   ...
   * @return pagination
  **/
  public IdentListResponsePagination getPagination() {
    return pagination;
  }

  public void setPagination(IdentListResponsePagination pagination) {
    this.pagination = pagination;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IdentListResponse identListResponse = (IdentListResponse) o;
    return Objects.equals(this.data, identListResponse.data) &&
        Objects.equals(this.pagination, identListResponse.pagination);
  }
  ...
  public String toString() {
    ...
    sb.append("class IdentListResponse {\n");
