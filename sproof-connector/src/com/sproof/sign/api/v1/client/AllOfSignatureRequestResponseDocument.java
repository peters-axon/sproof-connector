...
import com.sproof.sign.api.v1.client.Member;
import java.math.BigDecimal;
import java.time.LocalDate;
import java.util.List;
/**
 * AllOfSignatureRequestResponseDocument
 */
...
public class AllOfSignatureRequestResponseDocument extends Document {
  ...
  public String toString() {
    ...
    sb.append("class AllOfSignatureRequestResponseDocument {\n");
