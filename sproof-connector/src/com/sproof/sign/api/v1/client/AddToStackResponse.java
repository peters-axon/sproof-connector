...
public class AddToStackResponse {
  @JsonProperty("status")
  private String status = null;

  public AddToStackResponse status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AddToStackResponse addToStackResponse = (AddToStackResponse) o;
    return Objects.equals(this.status, addToStackResponse.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddToStackResponse {\n");
