...
import com.sproof.sign.api.v1.client.DocumentScreenConfiguration;
import com.sproof.sign.api.v1.client.EndScreenConfiguration;
import com.sproof.sign.api.v1.client.ProviderScreenConfiguration;
import com.sproof.sign.api.v1.client.SignScreenConfiguration;
import com.sproof.sign.api.v1.client.WelcomeScreenConfiguration;

/**
 * Customization options for the profile&#x27;s screens.
 */
...
public class FastlaneScreensConfiguration {
  @JsonProperty("welcome")
  private WelcomeScreenConfiguration welcome = null;

  @JsonProperty("document")
  private DocumentScreenConfiguration document = null;

  @JsonProperty("provider")
  private ProviderScreenConfiguration provider = null;

  @JsonProperty("sign")
  private SignScreenConfiguration sign = null;

  @JsonProperty("end")
  private EndScreenConfiguration end = null;

  public FastlaneScreensConfiguration welcome(WelcomeScreenConfiguration welcome) {
   ...
   * @return welcome
  **/
  public WelcomeScreenConfiguration getWelcome() {
    return welcome;
  }

  public void setWelcome(WelcomeScreenConfiguration welcome) {
    this.welcome = welcome;
  }

  public FastlaneScreensConfiguration document(DocumentScreenConfiguration document) {
   ...
   * @return document
  **/
  public DocumentScreenConfiguration getDocument() {
    return document;
  }

  public void setDocument(DocumentScreenConfiguration document) {
    this.document = document;
  }

  public FastlaneScreensConfiguration provider(ProviderScreenConfiguration provider) {
   ...
   * @return provider
  **/
  public ProviderScreenConfiguration getProvider() {
    return provider;
  }

  public void setProvider(ProviderScreenConfiguration provider) {
    this.provider = provider;
  }

  public FastlaneScreensConfiguration sign(SignScreenConfiguration sign) {
    this.sign = sign;
    return this;
  }
   ...
   * @return sign
  **/
  public SignScreenConfiguration getSign() {
    return sign;
  }

  public void setSign(SignScreenConfiguration sign) {
    this.sign = sign;
  }

  public FastlaneScreensConfiguration end(EndScreenConfiguration end) {
    this.end = end;
    return this;
  }
   ...
   * @return end
  **/
  public EndScreenConfiguration getEnd() {
    return end;
  }

  public void setEnd(EndScreenConfiguration end) {
    this.end = end;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FastlaneScreensConfiguration _fastlaneScreensConfiguration = (FastlaneScreensConfiguration) o;
    return Objects.equals(this.welcome, _fastlaneScreensConfiguration.welcome) &&
        Objects.equals(this.document, _fastlaneScreensConfiguration.document) &&
        Objects.equals(this.provider, _fastlaneScreensConfiguration.provider) &&
        Objects.equals(this.sign, _fastlaneScreensConfiguration.sign) &&
        Objects.equals(this.end, _fastlaneScreensConfiguration.end);
  }

  @Override
  public int hashCode() {
    return Objects.hash(welcome, document, provider, sign, end);
  }
  ...
  public String toString() {
    ...
    sb.append("class FastlaneScreensConfiguration {\n");
