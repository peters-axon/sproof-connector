...
import com.sproof.sign.api.v1.client.PlanMembers;
import com.sproof.sign.api.v1.client.PlanMembersPagination;
...
public class GetPlanMembersResponse {
  @JsonProperty("data")
  private PlanMembers data = null;

  @JsonProperty("pagination")
  private PlanMembersPagination pagination = null;

  @JsonProperty("all")
  private Integer all = null;

  @JsonProperty("userPlus")
  private Integer userPlus = null;

  @JsonProperty("user")
  private Integer user = null;

  public GetPlanMembersResponse data(PlanMembers data) {
    this.data = data;
    return this;
  }
   ...
   * @return data
  **/
  public PlanMembers getData() {
    return data;
  }

  public void setData(PlanMembers data) {
    this.data = data;
  }

  public GetPlanMembersResponse pagination(PlanMembersPagination pagination) {
   ...
   * @return pagination
  **/
  public PlanMembersPagination getPagination() {
    return pagination;
  }

  public void setPagination(PlanMembersPagination pagination) {
    this.pagination = pagination;
  }

  public GetPlanMembersResponse all(Integer all) {
    this.all = all;
    return this;
  }
  ...
  **/
  ...
  public GetPlanMembersResponse userPlus(Integer userPlus) {
   ...
   * @return userPlus
  **/
  public Integer getUserPlus() {
    return userPlus;
  }

  public void setUserPlus(Integer userPlus) {
    this.userPlus = userPlus;
  }

  public GetPlanMembersResponse user(Integer user) {
    this.user = user;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GetPlanMembersResponse getPlanMembersResponse = (GetPlanMembersResponse) o;
    return Objects.equals(this.data, getPlanMembersResponse.data) &&
        Objects.equals(this.pagination, getPlanMembersResponse.pagination) &&
        Objects.equals(this.all, getPlanMembersResponse.all) &&
        Objects.equals(this.userPlus, getPlanMembersResponse.userPlus) &&
        Objects.equals(this.user, getPlanMembersResponse.user);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, pagination, all, userPlus, user);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetPlanMembersResponse {\n");
