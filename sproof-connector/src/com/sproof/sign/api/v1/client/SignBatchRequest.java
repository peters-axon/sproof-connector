...
public class SignBatchRequest {
  ...
  public SignBatchRequest email(String email) {
    this.email = email;
    return this;
  }

   /**
   * Email of the member from the stack you want to sign (only QES)
   * @return email
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SignBatchRequest signBatchRequest = (SignBatchRequest) o;
    return Objects.equals(this.email, signBatchRequest.email);
  }
  ...
  public String toString() {
    ...
    sb.append("class SignBatchRequest {\n");
