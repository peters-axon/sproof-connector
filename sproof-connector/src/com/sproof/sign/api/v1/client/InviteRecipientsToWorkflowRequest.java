...
public class InviteRecipientsToWorkflowRequest {
  @JsonProperty("token")
  ...
  public InviteRecipientsToWorkflowRequest token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest workflowId(String workflowId) {
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest callbackUrl(String callbackUrl) {
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest returnUrl(String returnUrl) {
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest returnBtnText(String returnBtnText) {
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest inviteSuccessUrl(String inviteSuccessUrl) {
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest sender(InviteRecipientsToWorkflowRequestSender sender) {
    this.sender = sender;
    return this;
  }
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest dueDate(String dueDate) {
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest reminderInterval(BigDecimal reminderInterval) {
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest startSendingReminders(String startSendingReminders) {
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest recipients(List<WorkflowRecipient> recipients) {
    this.recipients = recipients;
    return this;
  }

  public InviteRecipientsToWorkflowRequest addRecipientsItem(WorkflowRecipient recipientsItem) {
  ...
  **/
  ...
  public InviteRecipientsToWorkflowRequest data(String data) {
    this.data = data;
    return this;
  }

   /**
   * Base64 encoded PDF data. If provided, this PDF will be used instead of the document stored in the workflow. If not provided, the workflow document will be used.
   * @return data
  **/
  ...
  public InviteRecipientsToWorkflowRequest fileName(String fileName) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InviteRecipientsToWorkflowRequest inviteRecipientsToWorkflowRequest = (InviteRecipientsToWorkflowRequest) o;
    return Objects.equals(this.token, inviteRecipientsToWorkflowRequest.token) &&
        Objects.equals(this.workflowId, inviteRecipientsToWorkflowRequest.workflowId) &&
        Objects.equals(this.callbackUrl, inviteRecipientsToWorkflowRequest.callbackUrl) &&
        Objects.equals(this.returnUrl, inviteRecipientsToWorkflowRequest.returnUrl) &&
        Objects.equals(this.returnBtnText, inviteRecipientsToWorkflowRequest.returnBtnText) &&
        Objects.equals(this.inviteSuccessUrl, inviteRecipientsToWorkflowRequest.inviteSuccessUrl) &&
        Objects.equals(this.sender, inviteRecipientsToWorkflowRequest.sender) &&
        Objects.equals(this.dueDate, inviteRecipientsToWorkflowRequest.dueDate) &&
        Objects.equals(this.reminderInterval, inviteRecipientsToWorkflowRequest.reminderInterval) &&
        Objects.equals(this.startSendingReminders, inviteRecipientsToWorkflowRequest.startSendingReminders) &&
        Objects.equals(this.recipients, inviteRecipientsToWorkflowRequest.recipients) &&
        Objects.equals(this.data, inviteRecipientsToWorkflowRequest.data) &&
        Objects.equals(this.fileName, inviteRecipientsToWorkflowRequest.fileName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, workflowId, callbackUrl, returnUrl, returnBtnText, inviteSuccessUrl, sender, dueDate, reminderInterval, startSendingReminders, recipients, data, fileName);
  }
  ...
  public String toString() {
    ...
    sb.append("class InviteRecipientsToWorkflowRequest {\n");
