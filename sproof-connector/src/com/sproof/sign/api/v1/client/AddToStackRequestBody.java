...
public class AddToStackRequestBody {
  @JsonProperty("token")
  ...
  public enum SignatureTypeEnum {
    AES_SPROOF("aes_sproof"),
    QES_SPROOF("qes_sproof");
  ...
  private SignatureTypeEnum signatureType = SignatureTypeEnum.QES_SPROOF;

  public AddToStackRequestBody token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public AddToStackRequestBody memberId(String memberId) {
  ...
  **/
  ...
  public AddToStackRequestBody signature(String signature) {
    this.signature = signature;
    return this;
  }

   /**
   * Base64 Encoded PNG File which represents the signature or seal, if a custom image is desired
   * @return signature
  **/
  ...
  public AddToStackRequestBody page(BigDecimal page) {
    this.page = page;
    return this;
  }
  ...
  **/
  ...
  public AddToStackRequestBody x(BigDecimal x) {
    this.x = x;
    return this;
  }
  ...
  **/
  ...
  public AddToStackRequestBody y(BigDecimal y) {
    this.y = y;
    return this;
  }
  ...
  **/
  ...
  public AddToStackRequestBody width(BigDecimal width) {
    this.width = width;
    return this;
  }
  ...
  **/
  ...
  public AddToStackRequestBody height(BigDecimal height) {
    this.height = height;
    return this;
  }
  ...
  **/
  ...
  public AddToStackRequestBody signatureType(SignatureTypeEnum signatureType) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AddToStackRequestBody _addToStackRequestBody = (AddToStackRequestBody) o;
    return Objects.equals(this.token, _addToStackRequestBody.token) &&
        Objects.equals(this.memberId, _addToStackRequestBody.memberId) &&
        Objects.equals(this.signature, _addToStackRequestBody.signature) &&
        Objects.equals(this.page, _addToStackRequestBody.page) &&
        Objects.equals(this.x, _addToStackRequestBody.x) &&
        Objects.equals(this.y, _addToStackRequestBody.y) &&
        Objects.equals(this.width, _addToStackRequestBody.width) &&
        Objects.equals(this.height, _addToStackRequestBody.height) &&
        Objects.equals(this.signatureType, _addToStackRequestBody.signatureType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, memberId, signature, page, x, y, width, height, signatureType);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddToStackRequestBody {\n");
