...
public class PrepareRecipientsWithWorkflowResponse {
  ...
  public PrepareRecipientsWithWorkflowResponse editorUrl(String editorUrl) {
    this.editorUrl = editorUrl;
    return this;
  }

   /**
   * The URL to open the draft document in the sproof sign editor and send out the invitations
   * @return editorUrl
  **/
  ...
  public PrepareRecipientsWithWorkflowResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PrepareRecipientsWithWorkflowResponse prepareRecipientsWithWorkflowResponse = (PrepareRecipientsWithWorkflowResponse) o;
    return Objects.equals(this.editorUrl, prepareRecipientsWithWorkflowResponse.editorUrl) &&
        Objects.equals(this.name, prepareRecipientsWithWorkflowResponse.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(editorUrl, name);
  }
  ...
  public String toString() {
    ...
    sb.append("class PrepareRecipientsWithWorkflowResponse {\n");
