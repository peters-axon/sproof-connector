...
/**
 * Configuration for the welcome screen shown to the End User
 */
...
public class CreateIdentRequestConfigStepsWelcome {
  ...
  public CreateIdentRequestConfigStepsWelcome enabled(Boolean enabled) {
  ...
  **/
  ...
  public CreateIdentRequestConfigStepsWelcome title(String title) {
    this.title = title;
    return this;
  }
  ...
  **/
  ...
  public CreateIdentRequestConfigStepsWelcome description(String description) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateIdentRequestConfigStepsWelcome createIdentRequestConfigStepsWelcome = (CreateIdentRequestConfigStepsWelcome) o;
    return Objects.equals(this.enabled, createIdentRequestConfigStepsWelcome.enabled) &&
        Objects.equals(this.title, createIdentRequestConfigStepsWelcome.title) &&
        Objects.equals(this.description, createIdentRequestConfigStepsWelcome.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, title, description);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIdentRequestConfigStepsWelcome {\n");
