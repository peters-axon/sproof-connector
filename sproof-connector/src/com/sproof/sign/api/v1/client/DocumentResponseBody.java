...
import com.sproof.sign.api.v1.client.SignatureDetail;
...
public class DocumentResponseBody {
  @JsonProperty("data")
  private String data = null;

  @JsonProperty("signatures")
  private List<SignatureDetail> signatures = null;

  public DocumentResponseBody data(String data) {
    this.data = data;
    return this;
  }

   /**
   * Base64 Encoded Signed PDF File
   * @return data
  **/
  ...
  public DocumentResponseBody signatures(List<SignatureDetail> signatures) {
    this.signatures = signatures;
    return this;
  }

  public DocumentResponseBody addSignaturesItem(SignatureDetail signaturesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DocumentResponseBody _documentResponseBody = (DocumentResponseBody) o;
    return Objects.equals(this.data, _documentResponseBody.data) &&
        Objects.equals(this.signatures, _documentResponseBody.signatures);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, signatures);
  }
  ...
  public String toString() {
    ...
    sb.append("class DocumentResponseBody {\n");
