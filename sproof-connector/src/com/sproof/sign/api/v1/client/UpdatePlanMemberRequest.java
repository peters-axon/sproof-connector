...
public class UpdatePlanMemberRequest {
  @JsonProperty("token")
  ...
  public UpdatePlanMemberRequest token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public UpdatePlanMemberRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public UpdatePlanMemberRequest firstName(String firstName) {
  ...
  **/
  ...
  public UpdatePlanMemberRequest lastName(String lastName) {
  ...
  **/
  ...
  public UpdatePlanMemberRequest blocked(Boolean blocked) {
    this.blocked = blocked;
    return this;
  }

   /**
   * If this is set to true, the member will be blocked starting with the date of this update request,  and will not be able to use the plans resources.
   * @return blocked
  **/
  ...
  public UpdatePlanMemberRequest userPlus(Boolean userPlus) {
    this.userPlus = userPlus;
    return this;
  }

   /**
   * If true, upgrade member to userPlus. If false, downgrades userPlus to user. Requires available userPlus counters for upgrades.
   * @return userPlus
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdatePlanMemberRequest updatePlanMemberRequest = (UpdatePlanMemberRequest) o;
    return Objects.equals(this.token, updatePlanMemberRequest.token) &&
        Objects.equals(this.email, updatePlanMemberRequest.email) &&
        Objects.equals(this.firstName, updatePlanMemberRequest.firstName) &&
        Objects.equals(this.lastName, updatePlanMemberRequest.lastName) &&
        Objects.equals(this.blocked, updatePlanMemberRequest.blocked) &&
        Objects.equals(this.userPlus, updatePlanMemberRequest.userPlus);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, email, firstName, lastName, blocked, userPlus);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdatePlanMemberRequest {\n");
