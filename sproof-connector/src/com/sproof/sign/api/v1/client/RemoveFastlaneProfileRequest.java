...
/**
 * Request body for removing a Fastlane profile from documents
 */
...
public class RemoveFastlaneProfileRequest {
  @JsonProperty("memberIds")
  private List<String> memberIds = null;

  public RemoveFastlaneProfileRequest memberIds(List<String> memberIds) {
    this.memberIds = memberIds;
    return this;
  }

  public RemoveFastlaneProfileRequest addMemberIdsItem(String memberIdsItem) {
   ...
   /**
   * List of admin memberIds where the Fastlane profile should be removed from.
   * @return memberIds
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RemoveFastlaneProfileRequest _removeFastlaneProfileRequest = (RemoveFastlaneProfileRequest) o;
    return Objects.equals(this.memberIds, _removeFastlaneProfileRequest.memberIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class RemoveFastlaneProfileRequest {\n");
