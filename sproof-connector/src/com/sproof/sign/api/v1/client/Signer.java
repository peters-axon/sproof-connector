...
import com.sproof.sign.api.v1.client.DefaultProvider;
...
public class Signer {
  ...
  private Boolean doNotSendEmail = null;
  ...
  private DefaultProvider defaultProvider = null;

  @JsonProperty("signaturePosition")
  private OneOfSignerSignaturePosition signaturePosition = null;
  ...
  **/
  ...
  public Signer doNotSendEmail(Boolean doNotSendEmail) {
  ...
  **/
  public Boolean isDoNotSendEmail() {
    return doNotSendEmail;
  }
  ...
  public Signer useFastlane(Boolean useFastlane) {
  ...
  **/
  ...
  public Signer customId(String customId) {
    this.customId = customId;
    return this;
  }

   /**
   * The customId can be used to create a document link for a recipient instead of using the memberId provided by the return object of the createSignatureRequest. Check [Using the custom ID](#section/Using-the-Custom-ID) for more information.  **Note: The customId can only be used to build the recipient link to a document. It can not be used for other requests instead of the memberId** 
   * @return customId
  **/
  ...
  public Signer isSigner(Boolean isSigner) {
  ...
  **/
  ...
  public Signer signingOrder(Integer signingOrder) {
    this.signingOrder = signingOrder;
    return this;
  }

   /**
   * The order when the signer will be notified to sign the document. The values for signingOrder start at 1. If there exists a smaller signingOrder then this signer needs to sign the document before.
   * @return signingOrder
  **/
  ...
  public Signer defaultProvider(DefaultProvider defaultProvider) {
  ...
  **/
  ...
  public Signer signaturePosition(OneOfSignerSignaturePosition signaturePosition) {
    this.signaturePosition = signaturePosition;
    return this;
  }

   /**
   * Array or one single signaturePosition Object. The signature position **relative to the height and width of the page**.
   * @return signaturePosition
  **/
  public OneOfSignerSignaturePosition getSignaturePosition() {
    return signaturePosition;
  }

  public void setSignaturePosition(OneOfSignerSignaturePosition signaturePosition) {
    this.signaturePosition = signaturePosition;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Signer _signer = (Signer) o;
    return Objects.equals(this.email, _signer.email) &&
        Objects.equals(this.firstName, _signer.firstName) &&
        Objects.equals(this.lastName, _signer.lastName) &&
        Objects.equals(this.doNotSendEmail, _signer.doNotSendEmail) &&
        Objects.equals(this.useFastlane, _signer.useFastlane) &&
        Objects.equals(this.customId, _signer.customId) &&
        Objects.equals(this.isSigner, _signer.isSigner) &&
        Objects.equals(this.signingOrder, _signer.signingOrder) &&
        Objects.equals(this.defaultProvider, _signer.defaultProvider) &&
        Objects.equals(this.signaturePosition, _signer.signaturePosition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, doNotSendEmail, useFastlane, customId, isSigner, signingOrder, defaultProvider, signaturePosition);
  }
  ...
  public String toString() {
    ...
    sb.append("    doNotSendEmail: ").append(toIndentedString(doNotSendEmail)).append("\n");
