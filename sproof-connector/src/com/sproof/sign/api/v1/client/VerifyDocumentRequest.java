...
public class VerifyDocumentRequest {
  ...
  public VerifyDocumentRequest data(String data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public VerifyDocumentRequest token(String token) {
    this.token = token;
    return this;
  }

   /**
   * Token for authentication (e.g. your API key). Can be provided here or as a query parameter.
   * @return token
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VerifyDocumentRequest verifyDocumentRequest = (VerifyDocumentRequest) o;
    return Objects.equals(this.data, verifyDocumentRequest.data) &&
        Objects.equals(this.token, verifyDocumentRequest.token);
  }
  ...
  public String toString() {
    ...
    sb.append("class VerifyDocumentRequest {\n");
