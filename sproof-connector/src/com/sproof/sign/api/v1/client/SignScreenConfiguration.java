...
/**
 * Settings for the signature screen. 
 */
...
public class SignScreenConfiguration {
  @JsonProperty("signOnDisplay")
  private Boolean signOnDisplay = true;

  @JsonProperty("signatureCard")
  private Boolean signatureCard = true;

  @JsonProperty("previewDocumentButton")
  private Boolean previewDocumentButton = true;

  public SignScreenConfiguration signOnDisplay(Boolean signOnDisplay) {
    this.signOnDisplay = signOnDisplay;
    return this;
  }

   /**
   * Determines whether the signature screen supports sign-on-display.
   * @return signOnDisplay
  **/
  public Boolean isSignOnDisplay() {
    return signOnDisplay;
  }

  public void setSignOnDisplay(Boolean signOnDisplay) {
    this.signOnDisplay = signOnDisplay;
  }

  public SignScreenConfiguration signatureCard(Boolean signatureCard) {
    this.signatureCard = signatureCard;
    return this;
  }

   /**
   * If set to true, the visual representation includes a signature card.
  ...
  **/
  ...
  public SignScreenConfiguration previewDocumentButton(Boolean previewDocumentButton) {
    this.previewDocumentButton = previewDocumentButton;
    return this;
  }

   /**
   * Displays the preview document button if enabled.
   * @return previewDocumentButton
  **/
  public Boolean isPreviewDocumentButton() {
    return previewDocumentButton;
  }

  public void setPreviewDocumentButton(Boolean previewDocumentButton) {
    this.previewDocumentButton = previewDocumentButton;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SignScreenConfiguration _signScreenConfiguration = (SignScreenConfiguration) o;
    return Objects.equals(this.signOnDisplay, _signScreenConfiguration.signOnDisplay) &&
        Objects.equals(this.signatureCard, _signScreenConfiguration.signatureCard) &&
        Objects.equals(this.previewDocumentButton, _signScreenConfiguration.previewDocumentButton);
  }

  @Override
  public int hashCode() {
    return Objects.hash(signOnDisplay, signatureCard, previewDocumentButton);
  }
  ...
  public String toString() {
    ...
    sb.append("class SignScreenConfiguration {\n");
    
    sb.append("    signOnDisplay: ").append(toIndentedString(signOnDisplay)).append("\n");
    sb.append("    signatureCard: ").append(toIndentedString(signatureCard)).append("\n");
    sb.append("    previewDocumentButton: ").append(toIndentedString(previewDocumentButton)).append("\n");
    sb.append("}");
    return sb.toString();
  }
