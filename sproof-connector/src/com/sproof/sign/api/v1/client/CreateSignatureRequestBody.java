...
import com.sproof.sign.api.v1.client.CSRInviteData;
import com.sproof.sign.api.v1.client.EnvelopeData;

/**
 * Request body for creating a new signature request
 */
...
public class CreateSignatureRequestBody {
  @JsonProperty("token")
  private String token = null;

  @JsonProperty("inviteData")
  private CSRInviteData inviteData = null;

  @JsonProperty("envelopeData")
  private EnvelopeData envelopeData = null;

  public CreateSignatureRequestBody token(String token) {
    this.token = token;
    return this;
  }
  ...
  **/
  ...
  public CreateSignatureRequestBody inviteData(CSRInviteData inviteData) {
   ...
   * @return inviteData
  **/
  public CSRInviteData getInviteData() {
    return inviteData;
  }

  public void setInviteData(CSRInviteData inviteData) {
    this.inviteData = inviteData;
  }

  public CreateSignatureRequestBody envelopeData(EnvelopeData envelopeData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateSignatureRequestBody createSignatureRequestBody = (CreateSignatureRequestBody) o;
    return Objects.equals(this.token, createSignatureRequestBody.token) &&
        Objects.equals(this.inviteData, createSignatureRequestBody.inviteData) &&
        Objects.equals(this.envelopeData, createSignatureRequestBody.envelopeData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, inviteData, envelopeData);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSignatureRequestBody {\n");
