...
import com.sproof.sign.api.v1.client.FastlaneScreensConfiguration;
import com.sproof.sign.api.v1.client.SuccessEmailConfiguration;

/**
 * Configuration settings for the Fastlane profile, including customizable screens and success email.
 */
...
public class FastlaneConfiguration {
  @JsonProperty("name")
  private String name = null;

  @JsonProperty("screens")
  private FastlaneScreensConfiguration screens = null;

  @JsonProperty("successEmail")
  private SuccessEmailConfiguration successEmail = null;

  @JsonProperty("backgroundColor")
  private String backgroundColor = "#FFFFFF";

  @JsonProperty("showAppBar")
  ...
  public FastlaneConfiguration name(String name) {
    this.name = name;
    return this;
  }

   /**
   * The name of the Fastlane profile that appears in the profile selector.
   * @return name
  **/
  ...
  public FastlaneConfiguration screens(FastlaneScreensConfiguration screens) {
   ...
   * @return screens
  **/
  public FastlaneScreensConfiguration getScreens() {
    return screens;
  }

  public void setScreens(FastlaneScreensConfiguration screens) {
    this.screens = screens;
  }

  public FastlaneConfiguration successEmail(SuccessEmailConfiguration successEmail) {
   ...
   * @return successEmail
  **/
  public SuccessEmailConfiguration getSuccessEmail() {
    return successEmail;
  }

  public void setSuccessEmail(SuccessEmailConfiguration successEmail) {
    this.successEmail = successEmail;
  }

  public FastlaneConfiguration backgroundColor(String backgroundColor) {
    this.backgroundColor = backgroundColor;
    return this;
  }

   /**
   * The background color of the Fastlane screens as a hex color.
  ...
  **/
  ...
  public FastlaneConfiguration showAppBar(Boolean showAppBar) {
    this.showAppBar = showAppBar;
    return this;
  }

   /**
   * If set to false, hides the app bar of the Fastlane.
   * @return showAppBar
  **/
  ...
  public FastlaneConfiguration showProgressBar(Boolean showProgressBar) {
    this.showProgressBar = showProgressBar;
    return this;
  }

   /**
   * If set to false, hides the progress bar of the Fastlane.
  ...
  **/
  ...
  public FastlaneConfiguration showHeader(Boolean showHeader) {
    this.showHeader = showHeader;
    return this;
  }

   /**
   * If set to false, hides the header in the signing-screen.
   * @return showHeader
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FastlaneConfiguration _fastlaneConfiguration = (FastlaneConfiguration) o;
    return Objects.equals(this.name, _fastlaneConfiguration.name) &&
        Objects.equals(this.screens, _fastlaneConfiguration.screens) &&
        Objects.equals(this.successEmail, _fastlaneConfiguration.successEmail) &&
        Objects.equals(this.backgroundColor, _fastlaneConfiguration.backgroundColor) &&
        Objects.equals(this.showAppBar, _fastlaneConfiguration.showAppBar) &&
        Objects.equals(this.showProgressBar, _fastlaneConfiguration.showProgressBar) &&
        Objects.equals(this.showHeader, _fastlaneConfiguration.showHeader);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, screens, successEmail, backgroundColor, showAppBar, showProgressBar, showHeader);
  }
  ...
  public String toString() {
    ...
    sb.append("class FastlaneConfiguration {\n");
    
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    screens: ").append(toIndentedString(screens)).append("\n");
    sb.append("    successEmail: ").append(toIndentedString(successEmail)).append("\n");
    sb.append("    backgroundColor: ").append(toIndentedString(backgroundColor)).append("\n");
    sb.append("    showAppBar: ").append(toIndentedString(showAppBar)).append("\n");
