...
import com.sproof.sign.api.v1.client.BaseScreenConfiguration;

/**
 * Settings for the end screen. 
 */
...
public class EndScreenConfiguration extends BaseScreenConfiguration {
  @JsonProperty("helpText")
  private Boolean helpText = true;

  @JsonProperty("shareDocumentBtn")
  private Boolean shareDocumentBtn = true;

  @JsonProperty("showDownloadDocBtn")
  private Boolean showDownloadDocBtn = true;

  public EndScreenConfiguration helpText(Boolean helpText) {
    this.helpText = helpText;
    return this;
  }

   /**
   * Displays help text on the end screen if enabled.
   * @return helpText
  **/
  ...
  public EndScreenConfiguration shareDocumentBtn(Boolean shareDocumentBtn) {
    this.shareDocumentBtn = shareDocumentBtn;
    return this;
  }

   /**
   * Displays the share document button if enabled.
   * @return shareDocumentBtn
  **/
  public Boolean isShareDocumentBtn() {
    return shareDocumentBtn;
  }

  public void setShareDocumentBtn(Boolean shareDocumentBtn) {
    this.shareDocumentBtn = shareDocumentBtn;
  }

  public EndScreenConfiguration showDownloadDocBtn(Boolean showDownloadDocBtn) {
    this.showDownloadDocBtn = showDownloadDocBtn;
    return this;
  }

   /**
   * Shows the download document button if enabled.
   * @return showDownloadDocBtn
  **/
  public Boolean isShowDownloadDocBtn() {
    return showDownloadDocBtn;
  }

  public void setShowDownloadDocBtn(Boolean showDownloadDocBtn) {
    this.showDownloadDocBtn = showDownloadDocBtn;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EndScreenConfiguration _endScreenConfiguration = (EndScreenConfiguration) o;
    return Objects.equals(this.helpText, _endScreenConfiguration.helpText) &&
        Objects.equals(this.shareDocumentBtn, _endScreenConfiguration.shareDocumentBtn) &&
        Objects.equals(this.showDownloadDocBtn, _endScreenConfiguration.showDownloadDocBtn) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(helpText, shareDocumentBtn, showDownloadDocBtn, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class EndScreenConfiguration {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    helpText: ").append(toIndentedString(helpText)).append("\n");
    sb.append("    shareDocumentBtn: ").append(toIndentedString(shareDocumentBtn)).append("\n");
    sb.append("    showDownloadDocBtn: ").append(toIndentedString(showDownloadDocBtn)).append("\n");
    sb.append("}");
    return sb.toString();
  }
