...
public class CreateFolderRequest {
  ...
  **/
  ...
  public CreateFolderRequest documentIds(List<String> documentIds) {
    this.documentIds = documentIds;
    return this;
  }

  public CreateFolderRequest addDocumentIdsItem(String documentIdsItem) {
    this.documentIds.add(documentIdsItem);
    return this;
  }

   /**
   * Document IDs of draft documents that should be combined into an envelope
   * @return documentIds
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateFolderRequest _createFolderRequest = (CreateFolderRequest) o;
    return Objects.equals(this.name, _createFolderRequest.name) &&
        Objects.equals(this.documentIds, _createFolderRequest.documentIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, documentIds);
  }
