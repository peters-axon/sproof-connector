...
public class Attachment implements DocumentData {
  @JsonProperty("data")
  ...
  private Map<String, DocumentRecipientDetails> recipientDetails = null;
  ...
  **/
  ...
  public Attachment boxes(List<Box> boxes) {
    this.boxes = boxes;
    return this;
  }

  public Attachment addBoxesItem(Box boxesItem) {
    if (this.boxes == null) {
   ...
   /**
   * An array of form fields that can be added to a document, allowing for various types of user input. Box type can be one of the following: textBoxMultiLine, dateBox, chooseBox, radioBox, checkBox, ibanBox.
   * @return boxes
  **/
  ...
  public Attachment signatureTypes(List<String> signatureTypes) {
    this.signatureTypes = signatureTypes;
    return this;
  }

  public Attachment addSignatureTypesItem(String signatureTypesItem) {
  ...
  **/
  ...
  public Attachment refId(String refId) {
    this.refId = refId;
    return this;
  }
  ...
  **/
  ...
  public Attachment folderId(String folderId) {
  ...
  **/
  ...
  public Attachment isAttachment(Boolean isAttachment) {
    this.isAttachment = isAttachment;
    return this;
  }

   /**
   * True to indicate the document is an attachment.
   * @return isAttachment
  **/
  ...
  public Attachment recipientDetails(Map<String, DocumentRecipientDetails> recipientDetails) {
    this.recipientDetails = recipientDetails;
    return this;
  }

  public Attachment putRecipientDetailsItem(String key, DocumentRecipientDetails recipientDetailsItem) {
    if (this.recipientDetails == null) {
      this.recipientDetails = new HashMap<>();
    }
    this.recipientDetails.put(key, recipientDetailsItem);
    return this;
  }

   /**
   * recipientDetails is not needed in this case.
   * @return recipientDetails
  **/
  public Map<String, DocumentRecipientDetails> getRecipientDetails() {
    return recipientDetails;
  }

  public void setRecipientDetails(Map<String, DocumentRecipientDetails> recipientDetails) {
    this.recipientDetails = recipientDetails;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.data, attachment.data) &&
        ...
        Objects.equals(this.boxes, attachment.boxes) &&
        Objects.equals(this.signatureTypes, attachment.signatureTypes) &&
        Objects.equals(this.refId, attachment.refId) &&
        Objects.equals(this.language, attachment.language) &&
        Objects.equals(this.folderId, attachment.folderId) &&
        Objects.equals(this.isAttachment, attachment.isAttachment) &&
        Objects.equals(this.recipientDetails, attachment.recipientDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, mimetype, fileName, label, boxes, signatureTypes, refId, language, folderId, isAttachment, recipientDetails);
  }
