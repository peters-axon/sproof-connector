...
public class WelcomeScreenConfiguration extends BaseScreenConfiguration {
  @JsonProperty("showDocumentBtn")
  private Boolean showDocumentBtn = true;

  public WelcomeScreenConfiguration showDocumentBtn(Boolean showDocumentBtn) {
    this.showDocumentBtn = showDocumentBtn;
    return this;
  }

   /**
   * Determines whether a button to preview the document is shown.
   * @return showDocumentBtn
  **/
  public Boolean isShowDocumentBtn() {
    return showDocumentBtn;
  }

  public void setShowDocumentBtn(Boolean showDocumentBtn) {
    this.showDocumentBtn = showDocumentBtn;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WelcomeScreenConfiguration _welcomeScreenConfiguration = (WelcomeScreenConfiguration) o;
    return Objects.equals(this.showDocumentBtn, _welcomeScreenConfiguration.showDocumentBtn) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(showDocumentBtn, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class WelcomeScreenConfiguration {\n");
    sb.append("    ").append(toIndentedString(super.toString())).append("\n");
    sb.append("    showDocumentBtn: ").append(toIndentedString(showDocumentBtn)).append("\n");
    sb.append("}");
    return sb.toString();
  }
