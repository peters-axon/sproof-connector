...
/**
 * Configure a default signature provider for the invited recipient
 */
...
public class RecipientDefaultProvider {
  /**
   * This tag determines the identity provider that will be used for the signing process. Choose from a predefined set of supported providers.    &gt;**Note1:** Some providers are only available for certain signatureTypes, for example &#x60;&#x60;onetimeqes&#x60;&#x60; will require &#x60;&#x60;\&quot;signatureType\&quot; : [\&quot;qualifiedPlusIdent\&quot;]&#x60;&#x60;    **Note2:** When using &#x60;&#x60;sproof-qualified&#x60;&#x60; as default provider the recipient has to have an active sproof account with an active User+ licence.
   */
  public enum TagEnum {
    SPROOF_STANDARD("sproof-standard"),
    SPROOF_QUALIFIED("sproof-qualified"),
    SIMPLE("simple"),
    DTRUST("dtrust"),
    EVROTRUST("evrotrust"),
    SMARTID("smartid"),
    MOBILEID("mobileid"),
    IDAUSTRIA("idaustria"),
    SWISSCOM_CIBA("swisscom-ciba"),
    SWISSCOM_CIBA_ZERTES("swisscom-ciba-zertes"),
    PRIME("prime"),
    YES("yes"),
    SPID("spid"),
    BEIDCARD("beidcard"),
  ...
  private CountryEnum country = CountryEnum.ALL;

  public RecipientDefaultProvider tag(TagEnum tag) {
    this.tag = tag;
    return this;
  }
  ...
  **/
  ...
  public RecipientDefaultProvider canChange(Boolean canChange) {
  ...
  **/
  ...
  public RecipientDefaultProvider country(CountryEnum country) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RecipientDefaultProvider recipientDefaultProvider = (RecipientDefaultProvider) o;
    return Objects.equals(this.tag, recipientDefaultProvider.tag) &&
        Objects.equals(this.canChange, recipientDefaultProvider.canChange) &&
        Objects.equals(this.country, recipientDefaultProvider.country);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tag, canChange, country);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecipientDefaultProvider {\n");
