...
/**
 * Request body for batch deleting Fastlane profiles
 */
...
public class BatchDeleteRequest {
  ...
  public BatchDeleteRequest ids(List<UUID> ids) {
    this.ids = ids;
    return this;
  }

  public BatchDeleteRequest addIdsItem(UUID idsItem) {
    if (this.ids == null) {
   ...
   /**
   * List of profile IDs to be deleted
   * @return ids
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BatchDeleteRequest _batchDeleteRequest = (BatchDeleteRequest) o;
    return Objects.equals(this.ids, _batchDeleteRequest.ids);
  }
