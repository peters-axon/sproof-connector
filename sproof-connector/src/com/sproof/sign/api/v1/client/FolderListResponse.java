...
import com.sproof.sign.api.v1.client.FolderResponse;
...
public class FolderListResponse {
  @JsonProperty("data")
  private List<FolderResponse> data = null;

  @JsonProperty("pagination")
  private AllOfFolderListResponsePagination pagination = null;

  public FolderListResponse data(List<FolderResponse> data) {
    this.data = data;
    return this;
  }

  public FolderListResponse addDataItem(FolderResponse dataItem) {
    if (this.data == null) {
   ...
   * @return data
  **/
  public List<FolderResponse> getData() {
    return data;
  }

  public void setData(List<FolderResponse> data) {
    this.data = data;
  }

  public FolderListResponse pagination(AllOfFolderListResponsePagination pagination) {
   ...
   * @return pagination
  **/
  public AllOfFolderListResponsePagination getPagination() {
    return pagination;
  }

  public void setPagination(AllOfFolderListResponsePagination pagination) {
    this.pagination = pagination;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FolderListResponse _folderListResponse = (FolderListResponse) o;
    return Objects.equals(this.data, _folderListResponse.data) &&
        Objects.equals(this.pagination, _folderListResponse.pagination);
  }
