...
import com.sproof.sign.api.v1.client.CreateIdentRequestConfigStepsEnd;
import com.sproof.sign.api.v1.client.CreateIdentRequestConfigStepsWelcome;

/**
 * CreateIdentRequestConfigSteps
 */
...
public class CreateIdentRequestConfigSteps {
  @JsonProperty("welcome")
  private CreateIdentRequestConfigStepsWelcome welcome = null;

  @JsonProperty("end")
  private CreateIdentRequestConfigStepsEnd end = null;

  public CreateIdentRequestConfigSteps welcome(CreateIdentRequestConfigStepsWelcome welcome) {
   ...
   * @return welcome
  **/
  public CreateIdentRequestConfigStepsWelcome getWelcome() {
    return welcome;
  }

  public void setWelcome(CreateIdentRequestConfigStepsWelcome welcome) {
    this.welcome = welcome;
  }

  public CreateIdentRequestConfigSteps end(CreateIdentRequestConfigStepsEnd end) {
    this.end = end;
    return this;
  }
   ...
   * @return end
  **/
  public CreateIdentRequestConfigStepsEnd getEnd() {
    return end;
  }

  public void setEnd(CreateIdentRequestConfigStepsEnd end) {
    this.end = end;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateIdentRequestConfigSteps createIdentRequestConfigSteps = (CreateIdentRequestConfigSteps) o;
    return Objects.equals(this.welcome, createIdentRequestConfigSteps.welcome) &&
        Objects.equals(this.end, createIdentRequestConfigSteps.end);
  }

  @Override
  public int hashCode() {
    return Objects.hash(welcome, end);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIdentRequestConfigSteps {\n");
