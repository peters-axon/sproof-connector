...
/**
 * Validation results of a signature
 */
...
public class SignatureValidationResult {
  ...
  @JsonProperty("signatureVerificationResult")
  private String signatureVerificationResult = null;

  @JsonProperty("certificateVerificationResult")
  private String certificateVerificationResult = null;
  ...
  @JsonProperty("signatureQualification")
  private String signatureQualification = null;

  public SignatureValidationResult success(Boolean success) {
    this.success = success;
    return this;
  }

   /**
   * Indicates if the validation operation was successful
   * @return success
  **/
  ...
  public SignatureValidationResult errorMessage(String errorMessage) {
    this.errorMessage = errorMessage;
    return this;
  }

   /**
   * Error message if the validation operation failed
   * @return errorMessage
  **/
  ...
  public SignatureValidationResult valid(Boolean valid) {
    this.valid = valid;
    return this;
  }
  ...
  **/
  ...
  public SignatureValidationResult signatureValid(Boolean signatureValid) {
    this.signatureValid = signatureValid;
    return this;
  }

   /**
   * Indicates if the signature itself is valid
  ...
  **/
  ...
  public SignatureValidationResult certificateValid(Boolean certificateValid) {
    this.certificateValid = certificateValid;
    return this;
  }

   /**
   * Indicates if the certificate used for the signature is valid
  ...
  **/
  ...
  public SignatureValidationResult signatureVerificationResult(String signatureVerificationResult) {
  ...
  **/
  ...
  public SignatureValidationResult certificateVerificationResult(String certificateVerificationResult) {
  ...
  **/
  public String getCertificateVerificationResult() {
    return certificateVerificationResult;
  }

  public void setCertificateVerificationResult(String certificateVerificationResult) {
    this.certificateVerificationResult = certificateVerificationResult;
  }

  public SignatureValidationResult subject(String subject) {
  ...
  **/
  ...
  public SignatureValidationResult issuer(String issuer) {
    this.issuer = issuer;
    return this;
  }
  ...
  **/
  ...
  public SignatureValidationResult signatureQualification(String signatureQualification) {
    this.signatureQualification = signatureQualification;
    return this;
  }

   /**
   * Qualification of the signature
  ...
  **/
  ...
  public void setSignatureQualification(String signatureQualification) {
    this.signatureQualification = signatureQualification;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SignatureValidationResult _signatureValidationResult = (SignatureValidationResult) o;
    return Objects.equals(this.success, _signatureValidationResult.success) &&
        Objects.equals(this.errorMessage, _signatureValidationResult.errorMessage) &&
        Objects.equals(this.valid, _signatureValidationResult.valid) &&
        Objects.equals(this.signatureValid, _signatureValidationResult.signatureValid) &&
        Objects.equals(this.certificateValid, _signatureValidationResult.certificateValid) &&
        Objects.equals(this.signatureVerificationResult, _signatureValidationResult.signatureVerificationResult) &&
        Objects.equals(this.certificateVerificationResult, _signatureValidationResult.certificateVerificationResult) &&
        Objects.equals(this.subject, _signatureValidationResult.subject) &&
        Objects.equals(this.issuer, _signatureValidationResult.issuer) &&
        Objects.equals(this.signatureQualification, _signatureValidationResult.signatureQualification);
  }

  @Override
  public int hashCode() {
    return Objects.hash(success, errorMessage, valid, signatureValid, certificateValid, signatureVerificationResult, certificateVerificationResult, subject, issuer, signatureQualification);
  }
  ...
  public String toString() {
    ...
    sb.append("class SignatureValidationResult {\n");
    ...
    sb.append("    signatureVerificationResult: ").append(toIndentedString(signatureVerificationResult)).append("\n");
    sb.append("    certificateVerificationResult: ").append(toIndentedString(certificateVerificationResult)).append("\n");
    sb.append("    subject: ").append(toIndentedString(subject)).append("\n");
    sb.append("    issuer: ").append(toIndentedString(issuer)).append("\n");
    sb.append("    signatureQualification: ").append(toIndentedString(signatureQualification)).append("\n");
    sb.append("}");
    return sb.toString();
  }
