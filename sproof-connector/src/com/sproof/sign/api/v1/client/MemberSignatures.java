...
public class MemberSignatures {
  ...
  public MemberSignatures signatureType(String signatureType) {
    this.signatureType = signatureType;
    return this;
  }

   /**
   * Type of signature (e.g. aes_sproof)
  ...
  **/
  ...
  public MemberSignatures signedAt(OffsetDateTime signedAt) {
    this.signedAt = signedAt;
    return this;
  }

   /**
   * Timestamp when the signature was applied (ISO 8601 datetime string)
   * @return signedAt
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MemberSignatures _memberSignatures = (MemberSignatures) o;
    return Objects.equals(this.signatureType, _memberSignatures.signatureType) &&
        Objects.equals(this.signedAt, _memberSignatures.signedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(signatureType, signedAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberSignatures {\n");
