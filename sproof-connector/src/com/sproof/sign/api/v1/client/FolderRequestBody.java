...
import com.sproof.sign.api.v1.client.FolderSigner;
...
public class FolderRequestBody {
  ...
  private List<FolderSigner> signers = new ArrayList<>();

  public FolderRequestBody signers(List<FolderSigner> signers) {
    this.signers = signers;
    return this;
  }

  public FolderRequestBody addSignersItem(FolderSigner signersItem) {
   ...
   * @return signers
  **/
  public List<FolderSigner> getSigners() {
    return signers;
  }

  public void setSigners(List<FolderSigner> signers) {
    this.signers = signers;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FolderRequestBody _folderRequestBody = (FolderRequestBody) o;
    return Objects.equals(this.signers, _folderRequestBody.signers);
  }
  ...
  public String toString() {
    ...
    sb.append("class FolderRequestBody {\n");
