...
import com.sproof.sign.api.v1.client.FolderDocumentInvite;
...
public class FolderSigner {
  ...
  private List<FolderDocumentInvite> documents = null;

  public FolderSigner email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public FolderSigner firstName(String firstName) {
  ...
  **/
  ...
  public FolderSigner lastName(String lastName) {
  ...
  **/
  ...
  public FolderSigner isSigner(Boolean isSigner) {
    this.isSigner = isSigner;
    return this;
  }

   /**
   * Indicates if the person should be able to sign the document or can only view it
   * @return isSigner
  **/
  ...
  public FolderSigner documents(List<FolderDocumentInvite> documents) {
    this.documents = documents;
    return this;
  }

  public FolderSigner addDocumentsItem(FolderDocumentInvite documentsItem) {
   ...
   /**
   * List of document ids and signature positions
   * @return documents
  **/
  public List<FolderDocumentInvite> getDocuments() {
    return documents;
  }

  public void setDocuments(List<FolderDocumentInvite> documents) {
    this.documents = documents;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FolderSigner _folderSigner = (FolderSigner) o;
    return Objects.equals(this.email, _folderSigner.email) &&
        Objects.equals(this.firstName, _folderSigner.firstName) &&
        Objects.equals(this.lastName, _folderSigner.lastName) &&
        Objects.equals(this.isSigner, _folderSigner.isSigner) &&
        Objects.equals(this.documents, _folderSigner.documents);
  }

  @Override
  public int hashCode() {
    return Objects.hash(email, firstName, lastName, isSigner, documents);
  }
