...
/**
 * Identity provider tag for the signing process
 */
public enum ProviderTag {
  ...
  @JsonCreator
  public static ProviderTag fromValue(String input) {
    for (ProviderTag b : ProviderTag.values()) {
