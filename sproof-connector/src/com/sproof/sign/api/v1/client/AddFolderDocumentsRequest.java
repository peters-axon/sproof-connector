...
/**
 * Request body for adding documents to an envelope
 */
...
public class AddFolderDocumentsRequest {
  @JsonProperty("documentIds")
  private List<String> documentIds = new ArrayList<>();

  public AddFolderDocumentsRequest documentIds(List<String> documentIds) {
    this.documentIds = documentIds;
    return this;
  }

  public AddFolderDocumentsRequest addDocumentIdsItem(String documentIdsItem) {
    this.documentIds.add(documentIdsItem);
    return this;
  }

   /**
   * List of document IDs to be added to the envelope
   * @return documentIds
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AddFolderDocumentsRequest _addFolderDocumentsRequest = (AddFolderDocumentsRequest) o;
    return Objects.equals(this.documentIds, _addFolderDocumentsRequest.documentIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddFolderDocumentsRequest {\n");
